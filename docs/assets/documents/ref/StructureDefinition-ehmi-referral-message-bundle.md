# EHMI Referring Message Bundle - DK MEDCOM REFERRAL LM v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EHMI Referring Message Bundle**

## Resource Profile: EHMI Referring Message Bundle 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk-medcom-ref-lm|current/StructureDefinition/StructureDefinition-ehmi-referral-message-bundle.json)
...
Other representations of profile: [CSV](StructureDefinition-ehmi-referral-message-bundle.csv), [Excel](StructureDefinition-ehmi-referral-message-bundle.xlsx), [Schematron](StructureDefinition-ehmi-referral-message-bundle.sch) 
...
```json
{
  ...
  "url" : "http://medcomehmi.dk/ig/dk-medcom-ref-lm/StructureDefinition/ehmi-referral-message-bundle",
  "version" : "0.1.0",
