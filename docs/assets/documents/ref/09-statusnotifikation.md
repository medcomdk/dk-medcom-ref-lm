# 09 Statusnotifikation - DK MEDCOM REFERRAL LM v0.1.0

* [**Table of Contents**](toc.md)
* **09 Statusnotifikation**
...
* **[Abonnement](StructureDefinition-ehmi-lm-abonnement.md)** — det abonnement der udløser notifikationen
* **[Henvisning](StructureDefinition-ehmi-lm-henvisning.md)** — den ressource der ændres
* **[Organisation](StructureDefinition-ehmi-lm-organisation.md)** — modtageren af notifikationen
