# 01 Henvisning - DK MEDCOM REFERRAL LM v0.1.0
...
* **[Patient](StructureDefinition-ehmi-lm-patient.md)** — subjektet for henvisningen
* **[Behandler](StructureDefinition-ehmi-lm-behandler.md)** — den der opretter og afsender
* **[Organisation](StructureDefinition-ehmi-lm-organisation.md)** — afsender og modtager
* **[KliniskDokumentation](StructureDefinition-ehmi-lm-klinisk-dokumentation.md)** — vedlagt materiale
* **[Visitationsafgoerelse](StructureDefinition-ehmi-lm-visitationsafgoerelse.md)** — udfaldet af visitationen
* **[Booking](StructureDefinition-ehmi-lm-booking.md)** — den aftalte tid ved accept
* **[Kommunikationsbesked](StructureDefinition-ehmi-lm-kommunikationsbesked.md)** — dialog om henvisningen
* **[Statusnotifikation](StructureDefinition-ehmi-lm-statusnotifikation.md)** — notifikationer ved statusskift
