# 10 Abonnement - DK MEDCOM REFERRAL LM v0.1.0
...
* **[Organisation](StructureDefinition-ehmi-lm-organisation.md)** — abonnenten
* **[Statusnotifikation](StructureDefinition-ehmi-lm-statusnotifikation.md)** — notifikationer udløst af dette abonnement
* **[Henvisning](StructureDefinition-ehmi-lm-henvisning.md)** — den ressource der abonneres på
