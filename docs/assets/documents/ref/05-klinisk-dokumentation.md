# 05 Klinisk Dokumentation - DK MEDCOM REFERRAL LM v0.1.0

* [**Table of Contents**](toc.md)
* **05 Klinisk Dokumentation**
...
* **[Henvisning](StructureDefinition-ehmi-lm-henvisning.md)** — dokumentationen er knyttet til en henvisning
* **[Behandler](StructureDefinition-ehmi-lm-behandler.md)** — forfatter til dokumentet
* **[Kommunikationsbesked](StructureDefinition-ehmi-lm-kommunikationsbesked.md)** — kan vedhæftes en besked som bilag
