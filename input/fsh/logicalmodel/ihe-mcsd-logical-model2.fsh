...
* contact             0..*  Reference(Contact) "Kontaktpersoner for organisationen"
...
Id: Contact
Title: "Kontaktperson"
Description: "Repræsenterer en kontaktperson for en organisation."
...
* endpoint[0] = Reference(ExampleFHIREndpoint)
