...
- **[Henvisning](StructureDefinition-ehmi-lm-henvisning.html)** — den primære kliniske payload
- **[Visitationsafgoerelse](StructureDefinition-ehmi-lm-visitationsafgoerelse.html)** — kan transporteres som fokus
