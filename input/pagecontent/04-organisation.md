...
- **[Behandler](StructureDefinition-ehmi-lm-behandler.html)** — behandlere er tilknyttet en organisation
- **[Henvisning](StructureDefinition-ehmi-lm-henvisning.html)** — afsender og modtager-organisation
- **[Abonnement](StructureDefinition-ehmi-lm-abonnement.html)** — organisationen er abonnent
- **[Meddelelseskonvolut](StructureDefinition-ehmi-lm-meddelelseskonvolut.html)** — routing via SOR/EHMI
