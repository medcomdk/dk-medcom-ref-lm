...
- **[Henvisning](StructureDefinition-ehmi-lm-henvisning.html)** — den afgørelse vedrører
- **[Behandler](StructureDefinition-ehmi-lm-behandler.html)** — visitatoren der afgør
- **[Statusnotifikation](StructureDefinition-ehmi-lm-statusnotifikation.html)** — afgørelsen udløser notifikation
- **[Booking](StructureDefinition-ehmi-lm-booking.html)** — oprettes ved accept
