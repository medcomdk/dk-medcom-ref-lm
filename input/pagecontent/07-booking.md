...
- **[Henvisning](StructureDefinition-ehmi-lm-henvisning.html)** — bookingen er resultatet af en accepteret henvisning
- **[Patient](StructureDefinition-ehmi-lm-patient.html)** — patienten der har fået tid
- **[Organisation](StructureDefinition-ehmi-lm-organisation.html)** — stedet for fremmøde
- **[Visitationsafgoerelse](StructureDefinition-ehmi-lm-visitationsafgoerelse.html)** — accept-afgørelsen udløser booking
